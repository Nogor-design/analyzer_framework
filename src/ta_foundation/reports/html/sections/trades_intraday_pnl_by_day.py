...
#         return None
#
#     x = df_sess["_entry_dt_local_naive"].tolist()
#     y_real = df_sess["_y_real"].tolist()
#     y_mfe = df_sess["_y_mfe"].tolist()
#
#     pnl_outcome = df_sess["_pnl"].tolist()
#     dir_signs = df_sess["_dir_sign"].tolist()
#
#     # ✅ Colors encode BOTH direction and outcome:
#     # Long win: green; Long loss: red
#     # Short win: purple; Short loss: orange
#     colors = []
...
#
#     if show_cum_line:
#         # direction-adjusted realized cumulative
#         try:
#             import pandas as pd
...
#             cum = []
#         if cum:
#             ax.plot(x, cum, linewidth=1.2, zorder=3)
#
